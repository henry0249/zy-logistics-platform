<template>
  <loading-box v-model="loadingText">
    <div class="body-padding body-height" v-getHeight>
      <my-table v-if="tableHeight>0" border size="mini" :height="tableHeight+'px'" index :loadmore="loadmore" :thead="thead" :data.sync="data">
