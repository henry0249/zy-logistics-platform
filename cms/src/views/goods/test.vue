<template>
  <div>
    <common-select label="选择" isSwitch :data.sync="value1" @switchChange="switchChange" :changeType.sync="changeType" border width="25%" title="用户选择" type="area" size="mini" :option="option"></common-select>
