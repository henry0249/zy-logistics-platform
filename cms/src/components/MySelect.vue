    ...
    <el-dialog append-to-body :title="title||autoTitle" :visible.sync="dialogVisible" width="70%" :top="multi?'7vh':'10vh'">
      <div style="height:55vh;overflow:hidden">
        <div v-if="dialogVisible">
          <common-table :select="data" :selection="multi" :option="searchOption" :path="path" :thead="thead" height="55vh" style="padding:0" @current-change="selectChange" @selection-change="handleSelectionChange">
